...
<nav class="navbar navbar-expand-lg">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <ul class="hstack gap-3 navbar-nav fs-3">
          ...
          <li class="nav-item">
            <a class="nav-link" href="/memo_announcement" aria-current="page" style="border-bottom: 5px solid #366DDA;color: #000000;">
              <i class="fa-regular fa-bell" ></i> ANNOUNCEMENTS</a>
          </li>
          <li class="nav-item">
