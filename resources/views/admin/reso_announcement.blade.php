...
@section('content')
  ...
  <nav class="navbar py-3" style="background-color: #D6D6D6;">
    <div class="container-fluid">
      ...
      <form class="d-flex" role="search" action="{{ route('search_reso') }}" method="GET">
  ...
  <div class="d-flex justify-content-center">
    <ul class="hstack gap-5 navbar-nav fs-3">
      ...
      <li class="nav-item">
        <a class="nav-link active" href="/reso_announcement" aria-current="page">Resolutions</a>
      </li>
      <li class="nav-item ">
        <a class="nav-link" href="/order_announcement">Executive Order</a>
      </li>
    </ul>
  </div>
    <div class="container">
      ...
      <tbody>
          ...
          <tr>
            ...
            <td>
               ...
               <a href="{{ route('delete_reso', $item->id) }}" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this file?')">Delete</a>
            </td> 
         </tr>
      ...
      <div class="modal-dialog modal-dialog-centered">
          <div class="modal-content">
              ...
              <div class="modal-body">
                  ...
                  <form action="{{ route('upload_reso') }}" method="POST" enctype="multipart/form-data">
                      @csrf
                      <div class="mt-4 mb-5">
